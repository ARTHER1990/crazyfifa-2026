...
def main():
    print("🚀 เริ่มกระบวนการเพิ่มตารางการแข่งขัน 3 แมตช์ใหม่ (Match ID 86, 87, 88) เข้ารอบ 32 ทีมสุดท้าย...")

    # ตารางการแข่งขันรอบ 32 ทีมสุดท้าย (Match ID 86 ถึง 88)
    # เวลาสะท้อนตามเวลาไทย UTC+7 เช้าวันเสาร์ที่ 4 กรกฎาคม 2026
    new_matches = [
        {
            'id': '86',
            'home_team': 'Argentina',
            'away_team': 'Cape Verde',
            'match_time': '2026-07-04 05:00:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
        },
        {
            ...
            'home_team': 'Australia',
            'away_team': 'Egypt',
            'match_time': '2026-07-04 08:00:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
        },
        {
            ...
            'home_team': 'Colombia',
            'away_team': 'Ghana',
            'match_time': '2026-07-04 08:30:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
    ...
    print("⚽ ตารางการแข่งขัน 3 คู่ใหม่ (ID 86 ถึง 88) แสดงบนเว็บบอร์ดเรียบร้อยแล้ว!")
