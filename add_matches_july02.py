...
def main():
    print("🚀 เริ่มกระบวนการเพิ่มตารางการแข่งขัน 3 แมตช์ใหม่ของวันที่ 2 กรกฎาคม 2026 (รอบ 32 ทีมสุดท้าย)...")

    # ตารางการแข่งขันรอบ 32 ทีมสุดท้าย (Match ID 83 ถึง 85)
    # เวลาในที่นี้อิงตามเวลาในประเทศไทย (คาบเกี่ยวเช้ามืดวันที่ 3 กรกฎาคม 2026)
    new_matches = [
        {
            'id': '84',
            'home_team': 'Spain',
            'away_team': 'Austria',
            'match_time': '2026-07-03 02:00:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
        },
        {
            ...
            'home_team': 'Portugal',
            'away_team': 'Croatia',
            'match_time': '2026-07-03 06:00:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
        },
        {
            ...
            'away_team': 'Algeria',
            'match_time': '2026-07-03 10:00:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
    ...
    print("⚽ ตารางการแข่งขัน 3 คู่ใหม่ (ID 83 ถึง 85) ประจำวันที่ 2 กรกฎาคม 2026 แสดงบนเว็บบอร์ดเรียบร้อยแล้ว!")
