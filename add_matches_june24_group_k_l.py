...
def main():
    print("🚀 เริ่มกระบวนการเพิ่มตารางการแข่งขัน 4 แมตช์ใหม่ของวันที่ 24 มิถุนายน 2026 (กลุ่ม K และ L) เข้าสู่ระบบ...")

    # ตาราง 4 คู่แข่งขันตกหล่นของกลุ่ม K และ L สำหรับวันที่ 24 มิถุนายน 2026 (เวลาไทย)
    new_matches = [
        {
            'id': '57',
            'home_team': 'Portugal',
            'away_team': 'Uzbekistan',
            'match_time': '2026-06-24 00:00:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
        },
        {
            ...
            'home_team': 'England',
            'away_team': 'Ghana',
            'match_time': '2026-06-24 03:00:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
        },
        {
            ...
            'home_team': 'Panama',
            'away_team': 'Croatia',
            'match_time': '2026-06-24 06:00:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
        },
        {
            ...
            'home_team': 'Colombia',
            'away_team': 'DR Congo',
            'match_time': '2026-06-24 09:00:00',
            'home_score': '',
            'away_score': '',
            'status': 'Upcoming',
            'scorers': ''
    ...
    try:
        ...
        print(f"✅ บันทึกข้อมูลลง Google Sheets เรียบร้อยแล้ว! (เพิ่มใหม่ {sheets_added} คู่, อัปเดต {sheets_updated} คู่)")
    ...
    print("⚽ ตารางการแข่งขัน 4 คู่ใหม่ (ID 57 ถึง 60) ของวันที่ 24 มิถุนายน 2026 แสดงบนเว็บบอร์ดเรียบร้อยแล้ว!")
